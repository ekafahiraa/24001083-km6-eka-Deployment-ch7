        ...
        <div className="max-w-[1200px] mx-auto flex justify-between py-5 px-5 flex-wrap gap-3 footer">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <p className="text-white mt-4 text-sm text-justify">
              ...
              berbagai konten film dari seluruh dunia. Temukan pengalaman
              menonton yang tak terbatas dengan koleksi kami yang terus
          ...
          <div className="flex flex-col items-end space-y-4 md:space-y-5">
            <a
              href="https://www.facebook.com/ekafahiraaprilia.fira"
              className="text-light"
            >
              <FaFacebook style={{ fontSize: "28px" }} />
            </a>
            <a href="https://twitter.com/finddmeinside" className="text-light">
              <BsTwitterX style={{ fontSize: "28px" }} />
            </a>
            <a
              href="https://www.instagram.com/ekafahiraa?igsh=Nzd4anNmdjgyOHlu"
              className="text-light"
            >
